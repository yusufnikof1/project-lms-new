...
if (isset($_POST['save'])) {
    ...
    $insert = mysqli_query($con, "INSERT INTO majors (name, is_active) VALUES ('$name', '$is_active')");
    if ($insert) {
...
if (isset($_GET['Edit'])) {
    ...
    $qEdit = mysqli_query($con, "SELECT * FROM majors WHERE id = $id");
...
if (isset($_POST['edit'])) {
    ...
    $name = $_POST['name'];
    $is_active = $_POST['is_active'];
    $qUpdate = mysqli_query($con, "UPDATE majors SET name='$name', is_active='$is_active'  WHERE id = $id");
    if ($qUpdate) {
        header("location: majors.php");
    }
}
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="majors.php">Dashboard</a></li>
