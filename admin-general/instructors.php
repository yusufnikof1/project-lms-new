...
if (isset($_GET['idDel'])) {
    ...
    $delete = mysqli_query($con, "DELETE FROM instructors WHERE id = $id");
    if ($delete) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table table-responsive">
                                <a class="btn btn-primary mb-2 float-end" href="add_edit_instructors.php">CREATE</a>
                                <table class="table table-bordered">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-success btn-sm" href="add_edit_instructors.php?Edit=<?php echo $row['id'] ?>">Edit</a>
                                                <a class="btn btn-danger btn-sm" href="instructors.php?idDel=<?php echo $row['id'] ?>">Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                    } ?>
