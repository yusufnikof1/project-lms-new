                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table table-responsive">
                                <a class="btn btn-primary mb-2 float-end" href="add_edit_students.php">CREATE</a>
                                <table class="table table-bordered">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-success btn-sm" href="add_edit_students.php?Edit=<?php echo $row['id'] ?>">Edit</a>
                                                <a class="btn btn-danger btn-sm" href="students.php?idDel=<?php echo $row['id'] ?>">Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                    } ?>
