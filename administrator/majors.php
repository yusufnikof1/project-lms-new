...
$majors = mysqli_query($con, "SELECT * FROM majors");
$rows = mysqli_fetch_all($majors, MYSQLI_ASSOC);
// var_dump($rows);

if (isset($_GET['idDel'])) {
    $id = $_GET['idDel'];

    $delete = mysqli_query($con, "DELETE FROM majors WHERE id = $id");
    if ($delete) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table table-responsive">
                                <a class="btn btn-primary mb-2 float-end" href="add_edit_majors.php">CREATE</a>
                                <table class="table table-bordered">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-success btn-sm" href="add_edit_majors.php?Edit=<?php echo $row['id'] ?>">Edit</a>
                                                <a class="btn btn-danger btn-sm" href="majors.php?idDel=<?php echo $row['id'] ?>">Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                    } ?>
