                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table table-responsive">
                                <a class="btn btn-primary mb-2 float-end" href="add_edit_users.php">CREATE</a>
                                <table class="table table-bordered">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-warning btn-sm" href="add_role_users.php?AddRole=<?php echo $row['id'] ?>">Add Role</a>
                                                <a class="btn btn-success btn-sm" href="add_edit_users.php?Edit=<?php echo $row['id'] ?>">Edit</a>
                                                <a class="btn btn-danger btn-sm" href="users.php?idDel=<?php echo $row['id'] ?>">Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                    } ?>
