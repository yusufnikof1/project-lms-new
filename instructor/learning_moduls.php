...
if (isset($_GET['idDel'])) {
    ...
    $delete = mysqli_query($con, "DELETE FROM learning_moduls WHERE id = $id");
    if ($delete) {
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>List of Learning Modul</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="instructor_dashboard.php">Dashboard</a></li>
                    <li class="breadcrumb-item active">Learning Moduls</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Learning Moduls</h5>
                            <div class="table table-responsive">
                                <a class="btn btn-primary mb-2 float-end" href="add_edit_learning_moduls.php">CREATE</a>
                                <table class="table table-bordered">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-success btn-sm" href="add_edit_learning_moduls.php?Edit=<?php echo $row['id'] ?>">Edit</a>
                                                <a class="btn btn-danger btn-sm" href="learning_moduls.php?idDel=<?php echo $row['id'] ?>">Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                    } ?>
